...
from year2022.day05.puzzles import read_data, first_puzzle, second_puzzle

FIRST_PUZZLE_TEST_ANSWER = 'CMZ'
FIRST_PUZZLE_REAL_ANSWER = 'TPGVQPFDH'
SECOND_PUZZLE_TEST_ANSWER = 'MCD'
SECOND_PUZZLE_REAL_ANSWER = 'DMRDFRHHH'


class Year2022Day05Test(TestCase):

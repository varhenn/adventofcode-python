...
from year2022.day16.puzzles import read_data, first_puzzle, second_puzzle

FIRST_PUZZLE_TEST_ANSWER = 1651
FIRST_PUZZLE_REAL_ANSWER = 1796
SECOND_PUZZLE_TEST_ANSWER = 1707
SECOND_PUZZLE_REAL_ANSWER = 1999


class Year2022Day16Test(TestCase):
